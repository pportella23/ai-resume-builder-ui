...
import { ArrowLeft, Globe, ExternalLink, Edit, Download, CheckCircle, Building2, Code, GraduationCap, Award, Link as LinkIcon, Mail, Phone, MapPin } from 'lucide-react'
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>
                    Your portfolio is {portfolio.status === 'deployed' ? 'live and deployed' : portfolio.status}
                  </CardDescription>
                </div>
                <div className="flex gap-2">
                  {portfolio.domain_name && (
                    <Button variant="outline" asChild>
                      <a href={`https://${portfolio.domain_name}`} target="_blank" rel="noopener noreferrer">
            ...
            <CardContent>
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-600">
                  Status: <span className="font-medium capitalize">{portfolio.status}</span>
                </span>
                {portfolio.domain_name && (
                  <>
                    <span className="text-gray-400">•</span>
                    <span className="text-gray-600">
                      Domain: <span className="font-medium">{portfolio.domain_name}</span>
                    </span>
                  </>
                )}
              </div>
            ...
            <>
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h3 className="text-2xl font-bold">{content.personal_info.name}</h3>
                    <p className="text-lg text-gray-600 mt-1">{content.personal_info.title}</p>
                    <p className="text-gray-600 mt-3">{content.personal_info.summary}</p>
                  </div>
