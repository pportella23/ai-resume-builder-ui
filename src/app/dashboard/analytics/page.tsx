      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {Math.floor(analytics.avgTimeOnSite / 60)}m{" "}
                {analytics.avgTimeOnSite % 60}s
              </div>
              <p className="text-xs text-muted-foreground">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardContent>
              <div className="space-y-4">
                {analytics.referrers.map((referrer, index) => {
                  const total = analytics.referrers.reduce(
                    (sum, r) => sum + r.count,
                    0
                  );
                  const percentage = ((referrer.count / total) * 100).toFixed(
                    1
                  );
                  return (
            ...
            <CardContent>
              <div className="space-y-4">
                {analytics.devices.map((device, index) => {
                  const total = analytics.devices.reduce(
                    (sum, d) => sum + d.count,
                    0
                  );
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage your portfolio analytics</CardDescription>
            </CardHeader>
